...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx40857b4a7a0f4caa',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'abb1c1309a6cd00c04de6ee423328ad4',
  ...
  USERS: [
    {
      ...
      id: 'oRima5mrh8pfbIeueSO0ecxTqx-0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'MhDI-J9YTI3HqFWJgE0dhbwX1-DSakjqkjdsIpqJJoI',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '成都',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '1998', date: '08-04',
        },
        {
          type: '*节日', name: '在一起纪念日', year: '2021', date: '09-05',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-09-05' },
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: 'oRima5smT0cz_IEUzCSShmCsQquo',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oRima5smT0cz_IEUzCSShmCsQquo',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '生日', name: '老婆', year: '1998', date: '08-04', isShowAge: true,
    },
    {
      type: '*节日', name: '在一起纪念日', year: '2021', date: '09-05',
    },
